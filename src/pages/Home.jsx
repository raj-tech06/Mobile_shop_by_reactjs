...
// //     console.log("Clicked Add to Cart:", mobile);  // ✅ चेक करो ये आ रहा है या नहीं
// //     console.log("Current Cart:", cart);  // ✅ ये देखो कि Cart अपडेट हो रहा है या नहीं
  
// //     const updatedCart = cart.some(item => item.id === mobile.id)
// //       ? cart.map(item => item.id === mobile.id ? { ...item, quantity: item.quantity + 1 } : item)
// //       : [...cart, { ...mobile, quantity: 1 }];
  
// //     setCart(updatedCart);
// //     console.log("Updated Cart:", updatedCart); // ✅ Updated Cart सही आ रहा है?
...
// //             <div className="card">
// //               <img src={mobile.img} alt={mobile.name} className="card-img-top" />
